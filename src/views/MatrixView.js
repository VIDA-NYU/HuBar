...
export function updateMatrix( dataFiles ){
    ...
    groupArray.forEach((id)=>{
        ...
        groupedObj.forEach((session)=>{
            ...
            if (d3.select("#brain-checkbox").property("checked") == true){
    ...
    function createBrainVis(row, step){
        ...
        const points = [
            {x: midXPoint - 0.3 * span, y: midYPoint - 0.30 * span, value: Math.random()*2 - 1},
            {x: midXPoint - 0.1 * span, y: midYPoint - 0.30 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.1 * span, y: midYPoint - 0.30 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.3 * span, y: midYPoint - 0.30 * span, value: Math.random()*2 - 1},

            {x: midXPoint - 0.3 * span, y: midYPoint - 0.15 * span, value: Math.random()*2 - 1},
            {x: midXPoint - 0.1 * span, y: midYPoint - 0.15 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.1 * span, y: midYPoint - 0.15 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.3 * span, y: midYPoint - 0.15 * span, value: Math.random()*2 - 1},

            {x: midXPoint - 0.3 * span,  y: midYPoint + 0.10 * span, value: Math.random()*2 - 1},
            {x: midXPoint - 0.1 * span, y: midYPoint + 0.10 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.1 * span, y: midYPoint + 0.10 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.3 * span, y: midYPoint + 0.10 * span, value: Math.random()*2 - 1},

            {x: midXPoint - 0.3 * span, y: midYPoint + 0.25 * span, value: Math.random()*2 - 1},
            {x: midXPoint - 0.1 * span, y: midYPoint + 0.25 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.1 * span, y: midYPoint + 0.25 * span, value: Math.random()*2 - 1},
            {x: midXPoint + 0.3 * span, y: midYPoint + 0.25 * span, value: Math.random()*2 - 1},
        ];
