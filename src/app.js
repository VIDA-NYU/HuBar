...
import { get_allTimestamps, get_maxTimestamp, process_timestamps } from './views/config.js'
...
Promise.all([
    ...
    .then(function(files) {
        ...
        updateScatterplot(selectedGroupby, selectedFilter, selectedScatterSource,  margins, dataFiles, scatterGroup, scatterSvg,
            fnirsGroup, fnirsSvg, timeDistGroup, timeDistSvg, hl2Group, videoPlayer, maxTimestamp, scatterScaleEncoding, selectedItems);
...
function initializeContainers(){
    ...
    sourceDropdown.on("change", function() {
        ...
        updateScatterplot(selectedGroupby, selectedFilter, selectedScatterSource,  margins, dataFiles, scatterGroup, scatterSvg, fnirsGroup, fnirsSvg,
            timeDistGroup, timeDistSvg, hl2Group, videoPlayer, maxTimestamp, scatterScaleEncoding, selectedItems);
        // selectedItems = [];
        updateFnirsAgg(selectedItems, selectedGroupby, selectedFilter, fnirsGroup, scatterGroup, fnirsSvg, timeDistGroup, timeDistSvg, hl2Group, videoPlayer, maxTimestamp, margins, dataFiles);
        updateTimeDistribution(selectedItems, selectedFilter, selectedGroupby, timeDistGroup, timeDistSvg, maxTimestamp, margins, dataFiles);
        updateEventTimeline();
