...
Promise.all([
    ...
    .then(function(files) {
        ...
        updateScatterplot(selectedGroupby, selectedFilter, selectedScatterSource,  margins, dataFiles, scatterGroup, scatterSvg, fnirsGroup, fnirsSvg, scatterScaleEncoding, selectedItems);
